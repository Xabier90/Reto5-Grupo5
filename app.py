...
def login():
    ...
    if request.method == "POST":
        ...
        sSQL = "SELECT correo, contraseña AS contra, tipo_usuario FROM usuarios where correo = %s" 
        cursor.execute(sSQL, [correo_usuario])# selecciona en este caso en la tabla usuarios, todas las columnas. 
